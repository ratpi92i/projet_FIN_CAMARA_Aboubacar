                ...
                <form action="{{ route('hospitals.update', $hospital->id) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom"
                            value="{{ $hospital->nom }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="ville" class="form-label">Ville</label>
                        <input type="text" class="form-control" id="ville" name="ville"
                            value="{{ $hospital->ville }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="localisation" class="form-label">Localisation</label>
                        <textarea class="form-control" id="localisation" name="localisation" rows="3" required>{{ $hospital->localisation }}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    @if ($hospital->image)
                        <div class="mb-3">
                            <img src="{{ asset($hospital->image) }}" alt="Hospital Image" style="max-width: 200px;">
                        </div>
                    @endif
