    ...
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="widget-data.html">gerer</a></li>
                            </ul>
                        </li>
            ...
            <div class="main-content">
                ...
                <div class="container">
                    <h1>Ajouter une nouvelle maladie</h1>
                    <form method="POST" action="{{ route('maladies.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="traitement" name="traitement" rows="4" required></textarea>
                        </div>
                        <div class="form-group">
