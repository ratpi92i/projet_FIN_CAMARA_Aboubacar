                ...
                <div class="rendezvous-list">
                    @foreach($rendezvous as $rdv)
                        <div class="rendezvous-item">
                            <h2>Rendez-vous pour {{ $rdv->utilisateur->nom }} {{ $rdv->utilisateur->prenom }}</h2>
                            <p> Contact: {{ $rdv->utilisateur->contact }}</p>
                            <p>Hôpital : {{ $rdv->hospital->nom }}</p>
                            <p>Date et heure : {{ $rdv->date_time }}</p>
